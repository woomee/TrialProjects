...
exports.addMessageTS = functions.https.onRequest(async (req, res) => {
  // Grab the text parameter.
  const original = req.query.text;
  // Push the new message into Cloud Firestore using the Firebase Admin SDK.
  const writeResult = await admin.firestore().collection("messages_ts")
...
exports.makeUppercaseTS =
  functions.firestore.document("/messages_ts/{documentId}")
      .onCreate((snap, context) => {
        ...
        // a Functions such as writing to Cloud Firestore.
