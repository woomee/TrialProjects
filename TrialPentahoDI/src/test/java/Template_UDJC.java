...
/**
 * Pentaho DIにて「ユーザ定義Java」ステップを試すテンプレート
 *
 * [利用方法]
 ...
 *
 */
public class Template_UDJC extends TransformClassBase {

	public Template_UDJC(UserDefinedJavaClass parent, UserDefinedJavaClassMeta meta, UserDefinedJavaClassData data)
	...
	{
		/* 最初の1回目(1行目)はfirst == trueとなるが2行目以降ようにfalseを設定 */
		if (first){
	        first = false;
	        logBasic("first");
	    }
