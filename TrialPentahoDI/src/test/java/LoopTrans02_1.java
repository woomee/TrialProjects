 ...
 *
 */
public class LoopTrans02_1 extends TransformClassBase {

	public LoopTrans02_1(UserDefinedJavaClass parent, UserDefinedJavaClassMeta meta, UserDefinedJavaClassData data)
	...
	public boolean processRow(StepMetaInterface smi, StepDataInterface sdi) throws KettleException {
		...
		putRow(data.outputRowMeta, new Object[] {_loopCount});
		_loopCount++;
