 ...
 *
 * [処理内容]
 * ・ktrと同じディレクトリにある"data_text.xls"を読み込む
 * ・読み込んだ"col1"列を大文字にした"uppercase"列、小文字にした"lowercase"列として"data_text_convert.csv"として出力
 *
 * [トライアルポイント]
 ...
 *
 */
public class UpperCase4 extends TransformClassBase {

	public UpperCase4(UserDefinedJavaClass parent, UserDefinedJavaClassMeta meta, UserDefinedJavaClassData data)
	...
	public boolean processRow(StepMetaInterface smi, StepDataInterface sdi) throws KettleException {
		...
		class Converter {
			...
			public String toLower(String indata) {
		...
		String uppercase_value = converter.toUpper(test_value);
		String lowercase_value = converter.toLower(test_value);
