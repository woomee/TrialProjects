 ...
 *
 */
public class ConvertCSVLoop07_2_ExtractCSV extends TransformClassBase {

	public ConvertCSVLoop07_2_ExtractCSV(UserDefinedJavaClass parent, UserDefinedJavaClassMeta meta,
	...
	public boolean processRow(StepMetaInterface smi, StepDataInterface sdi) throws KettleException {
		try {
			...
			if (first) {
				...
				ValueMetaInterface[] valueMetaInterfaces = getTableValueMetaInterfaces(_tableColumns);
