 ...
 *
 */
public class ConvertCSVLoop01_1 extends TransformClassBase {

	public ConvertCSVLoop01_1(UserDefinedJavaClass parent, UserDefinedJavaClassMeta meta, UserDefinedJavaClassData data)
	...
	public boolean processRow(StepMetaInterface smi, StepDataInterface sdi) throws KettleException {
		...
		get(Fields.Out, "db_table").setValue(outputData, db_table);
